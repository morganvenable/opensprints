...
#to which we've added 'a' to remain string-friendly
...
#redTickData {0,5,9,12} indicates that Red ticked at 0, 10, 18 and 24 milliseconds, respectively
#redTickData.size * rollercircumference == current distance for red
#
#
#
#
